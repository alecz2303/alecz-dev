...
<div class="site-shell"><header class="site-header" data-reveal><a class="brand" href="{{ $isEnglish ? route('en.home') : route('home') }}" aria-label="{{ __('ui.nav.home') }}"><span class="brand-mark" aria-hidden="true">&gt;_</span><span>Alecz</span></a><div class="header-actions"><a class="locale-switch" href="{{ $isEnglish ? $spanishUrl : $englishUrl }}" hreflang="{{ $isEnglish ? 'es' : 'en' }}" aria-label="{{ __('ui.nav.language_label') }}">{{ __('ui.nav.language') }}</a><button class="nav-toggle" type="button" aria-expanded="false" aria-controls="primary-navigation" data-nav-toggle><span class="sr-only">{{ __('ui.nav.open') }}</span><span></span><span></span></button></div><nav class="site-nav" id="primary-navigation" aria-label="{{ __('ui.nav.label') }}" data-nav><a href="{{ $isEnglish ? route('en.home') : route('home') }}#proyectos">{{ __('ui.nav.projects') }}</a><a href="{{ $isEnglish ? route('en.home') : route('home') }}#servicios">{{ $isEnglish ? '~/services' : '~/servicios' }}</a><a href="{{ $isEnglish ? route('en.home') : route('home') }}#sobre-mi">{{ __('ui.nav.about') }}</a><a href="{{ $isEnglish ? route('en.home') : route('home') }}#contacto">{{ __('ui.nav.contact') }}</a></nav></header><main id="contenido">@yield('content') @unless($slug) @include('partials.professional-profile') @endunless</main></div>
@php($dockHome = $isEnglish ? route('en.home') : route('home'))
